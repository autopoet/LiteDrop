...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        configured_limit = _int("MAX_FILE_SIZE_BYTES", HARD_MAX_FILE_SIZE)
        origins = tuple(
            item.strip()
        ...
        return cls(
            ...
            download_secret=os.getenv(
                "DOWNLOAD_SECRET", "dev-download-secret-change-me"
            ),
            ...
            download_ticket_ttl_minutes=_int(
